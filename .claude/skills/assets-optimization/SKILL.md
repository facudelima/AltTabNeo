...
Whenever you change the file extension of a resource (.jpg → .heic, .png → .pdf, etc.), update [AltTabX.xcodeproj/project.pbxproj](AltTabX.xcodeproj/project.pbxproj). The places that need patching:
